				...
				<div class="row about-container">
					...
					<div class="col-lg-6 content order-lg-1 order-2">
						<p class="box-blue">"HYPERTRAC" is an international
							...
							processes, interface with service providers etc. It is for the
							benefit of Mankind and does not have restrictions for its usage.
							The sole Objective is to reduce the traffic and stress of service
							providers and contractors from visiting offices for the purpose
							of following up of Documents, files, proposals and Business
							Transactions as it helps in introducing a unique relationship
							between Business partners, Countries, State Governments, clients,
							contractors and security Agencies etc. HYPERTRAC will connect
							people on its platform for business, education, diplomatic and
							social purposes as this relationship will be of more benefits to
							all on the platform.</p>

						<!-- <div class="icon-box wow fadeInUp">
              <div class="icon"><i class="fa fa-shopping-bag"></i></div>
              <h4 class="title"><a href="">Background and justification</a></h4>
