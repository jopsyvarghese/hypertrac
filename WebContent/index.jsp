...
<body>
  ...
  <section id="intro" class="clearfix">
    <div class="container">
      ...
      <div class="intro-img">
        <img src="img/student-transparent-group-work.png" alt="" class="img-fluid">
      </div>

      <div class="intro-info">
        <h2>We provide<br><span>Service</span><br>for all your Applications!</h2>
        <div>
    ...
    <section id="services" class="section-bg">
      <div class="container">
        ...
        <header class="section-header">
          <h3>Services</h3>
          <p>
            We provide services for different government and non-government related needs, currently we offer the following
            services.
          </p>
        </header>
