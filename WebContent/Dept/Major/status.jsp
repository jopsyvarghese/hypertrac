                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group">
                        <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..."
                               aria-label="Search" aria-describedby="basic-addon2" style="height:40px;">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card-header bg-white">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <small>
                                        <strong class="rounded-pill bg-primary text-white" style="padding: 2px 4px;">
                                            Acknowledged
                                        </strong>
                                    </small>
                                </div>
                                <div class="col-sm-8">
                                    <small>
                                        Department 1 / Receiver: Sanal Kumar (Asst.Engineer) / sanalkumar@gmail.com
                                    </small>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-2">
                                    <small>
                                        <strong class="rounded-pill bg-warning text-white" style="padding: 2px 4px;">
                                            Processing
                                        </strong>
                                    </small>
                                </div>
                                <div class="col-sm-8">
                                    <small>
                                        Department 5 / Receiver: Sam Jacob (Asst.CMO) / samjacob@gmail.com
                                    </small>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-2">
                                    <small>
                                        <strong class="rounded-pill bg-success text-white" style="padding: 2px 4px;">
                                            Completed
                                        </strong>
                                    </small>
                                </div>
