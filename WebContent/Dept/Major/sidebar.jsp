<ul
	...
	<li class="nav-item"><a class="nav-link"
		href="inviteContractor.jsp"> <i class="fas fa-fw fa-handshake"></i>
			<span>Invitation to Contractor</span></a></li>

	<li class="nav-item"><a class="nav-link" href="manageCso.jsp">
			<i class="fas fa-fw fa-shield-alt"></i> <span>CSO</span>
	</a></li>
	...
	<li class="nav-item"><a class="nav-link" href="support.jsp"> <i
			class="fas fa-fw fa-handshake"></i> <span>Support</span></a></li>
	<!-- Divider -->
	<li><hr class="sidebar-divider d-none d-md-block"></li>
