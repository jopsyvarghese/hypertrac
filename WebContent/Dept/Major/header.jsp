...
<body>
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow mx-1"><a
			...
			aria-expanded="false"> <i class="fas fa-bell fa-fw"></i> <!-- Counter - Alerts -->
				<%
					int unreadCount = helper.getAppsUnreadCountByMcId(loggedInId);
					if (unreadCount > 0) {
 ...
 %>
			...
			<div
				...
				<%
					ResultSet rsNotification = helper.getAppNotificationByMcId(loggedInId);
 ...
 %> <span class="badge badge-danger badge-counter"><%=totalMessages%></span>
			...
			<div
				...
				<a class="dropdown-item text-center small text-gray-500"
					href="../readMore.jsp?q=<%=helper.encrypt("2")%>">Read More
					Messages</a>
			</div></li>
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			<div
				...
				<a class="dropdown-item"
					href="../profile.jsp?q=<%=helper.encrypt("2")%>"> <i
