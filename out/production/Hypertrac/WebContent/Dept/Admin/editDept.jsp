        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="text-center">
                    Add New Departments
                    <br/><br/>
                    <form action="addDeptFinal.html" method="post">
                        <table class="table table-hover table-responsive-lg">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="deptHead" class="form-control" value="Shanmugham Arivuvel"/>
                                </td>
                            </tr>
                            <tr>
                                <th>Department Name</th>
                                <td>
                                    <input type="text" name="deptName" class="form-control" value="Department 1"/>
                                </td>
                            </tr>
                        </table>
                        <br/>
