                        ...
                        <form action="#" method="post">
                            <table class="table table-responsive-lg">
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" name="docSubmit" value="1"> Yes
                                        <input type="radio" name="docSubmit" value="0"> No
                                    </td>
                                </tr>
                                <tr>
                                    <th>Office Visited</th>
                                    <td>
                                        <input type="radio" name="ofcVisit" value="1"> Yes
                                        <input type="radio" name="ofcVisit" value="0"> No
                                    </td>
                                </tr>
                                <tr>
                                    <th>Extra Documents Required</th>
                                    <td>
                                        <textarea class="form-control" name="extraDocs"></textarea>
                                    </td>
                                </tr>
                            </table>
                            <div class="text-center">
