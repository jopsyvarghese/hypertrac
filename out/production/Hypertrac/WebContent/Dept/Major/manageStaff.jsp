                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="text-center">
                            <a href="addStaff.html" class="btn btn-primary btn-sm">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <td>9995559990</td>
                                <td>
                                    <a href="editStaff.html"><span class="fa fa-pen"></span></a>
                                    &nbsp;&nbsp;
                                    <a href="deleteStaff.html" onclick="return confirmDelete();"><span class="fa fa-trash-alt"></span></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                ...
                                <td>
                                    <a href="editStaff.html"><span class="fa fa-pen"></span></a>
                                    &nbsp;&nbsp;
                                    <a href="deleteStaff.html"><span class="fa fa-trash-alt"></span></a>
                                </td>
                            </tr>
                            <tr>
                                <td>3</td>
