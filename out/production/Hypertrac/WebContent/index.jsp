			...
			<div class="container">
				...
				<div class="row about-container">
					...
					<div class="col-lg-6 content order-lg-1 order-2">
						<p>We keep track of our clients’ needs, and harness our
							expertise in the service industry to address them. By combining
							our experience and expertise, we ensure ideal environments with
							round-the-clock services and utilities that function flawlessly.
						</p>
						...
						<div class="icon-box wow fadeInUp">
							...
							<h4 class="title">
								<a href="">Responsible Customer Support</a>
							</h4>
						...
						<div class="icon-box wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="title">
								<a href="">Realtime Status Update</a>
							</h4>
				...
				<div class="row about-extra">
					...
					<div class="col-lg-6 wow fadeInUp pt-5 pt-lg-0">
						...
						<p>Ipsum in aspernatur ut possimus sint. Quia omnis est
							occaecati possimus ea. Quas molestiae perspiciatis occaecati qui
							rerum. Deleniti quod porro sed quisquam saepe. Numquam mollitia
						...
						<p>Ad vitae recusandae odit possimus. Quaerat cum ipsum
							...
							quidem expedita perferendis. Qui rerum eligendi ex doloribus quia
							sit. Porro rerum eum eum.</p>
					</div>
				</div>
				...
				<div class="row about-extra">
					...
					<div class="col-lg-6 wow fadeInUp pt-4 pt-lg-0 order-2 order-lg-1">
						...
						<p>Delectus alias ut incidunt delectus nam placeat in
							consequatur. Sed cupiditate quia ea quis. Voluptas nemo qui aut
							distinctio. Cumque fugit earum est quam officiis numquam. Ducimus
						...
						<p>Voluptas saepe natus quidem blanditiis. Non sunt impedit
							...
							nisi vitae debitis. Dolorem cupiditate est perferendis iusto.</p>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-5 offset-lg-1 wow bounceInUp"
						...
						<div class="box">
							<div class="icon">
								<i class="ion-ios-albums" style="color: #d6ff22;"></i>
							</div>
							<h4 class="title">
								<a href="">GLO</a>
							</h4>
					...
					<div class="col-md-6 col-lg-5 wow bounceInUp" data-wow-delay="0.2s"
						...
						<div class="box">
							<div class="icon">
								<i class="ion-ios-analytics" style="color: #4680ff;"></i>
							</div>
							<h4 class="title">
								<a href="">CHEVRON</a>
							</h4>
					...
					<div class="col-md-6 col-lg-5 offset-lg-1 wow bounceInUp"
						...
						<div class="box">
							<div class="icon">
								<i class="ion-ios-barcode" style="color: #d6ff22;"></i>
							</div>
							<h4 class="title">
								<a href="">Presidency</a>
							</h4>
					...
					<div class="col-md-6 col-lg-5 wow bounceInUp" data-wow-delay="0.2s"
						...
						<div class="box">
							<div class="icon">
								<i class="ion-ios-world" style="color: #4680ff;"></i>
							</div>
							<h4 class="title">
								<a href="">UK EMBASSY</a>
							</h4>
    ...
    ============================-->
		<section id="why-us" class="wow fadeIn">
			<div class="container">
				<header class="section-header">
					<h3>Why choose us?</h3>
					<p>We are the best in the industry to help you out for all your
						documents processing digitally.</p>
				</header>
					...
					<div class="col-lg-4 mb-4">
						<div class="card wow bounceInUp">
							...
							<div class="card-body">
								...
								<p class="card-text">All Your documents are shared to the
									authorities in a safer way with proper security.</p>
					...
					<div class="col-lg-4 mb-4">
						<div class="card wow bounceInUp">
							...
							<div class="card-body">
								...
								<p class="card-text">We are reliable. We pursue
									relationships based on transparency, persistence, mutual trust
									and integrity with our customers and clients.</p>
								<a href="#" class="readmore">Read more </a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 mb-4">
						<div class="card wow bounceInUp">
							...
							<div class="card-body">
								...
								<p class="card-text">We will make sure that all your data's
									are processed as fast as possible through our channel.</p>
								<a href="#" class="readmore">Read more </a>
							</div>
						</div>
					</div>
		...
		<section id="clients" class="section-bg">
			...
			<div class="container">
				...
				<div class="section-header">
					<h3>Our CLients</h3>
					<p>Sed ut perspiciatis unde omnis iste natus error sit
						voluptatem accusantium doloremque dere santome nida.</p>
				</div>
